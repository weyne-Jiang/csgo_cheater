...
void creatTransWin(HWND gameHand)
{
	...
	g_wClass.lpszClassName = L" ";
	g_wClass.lpszMenuName = L" ";
	...
	g_drawHand = CreateWindowEx(WS_EX_TOPMOST | WS_EX_TRANSPARENT | WS_EX_LAYERED, L" ", L" ", WS_POPUP, 1, 1, g_windowW, g_windowH, 0, 0, 0, 0);
